...
#c.JupyterHub.data_files_path = '/opt/cloudera/parcels/Anaconda/envs/jupyterhub35/share/jupyter/hub'
...
c.Spawner.cmd = '/opt/cloudera/parcels/Anaconda/envs/jupyterhub35/bin/jupyterhub-singleuser'
